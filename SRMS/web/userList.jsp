            ...
            <div class="search">
                ...
                <c:if test="${user_select}">
                    <form method="post" action="${user_select_url}">
                        <input type="text" placeholder="请输入关键字" name="uname" value="${msg}"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <c:if test="${user_details}">
                                <a href="userView.jsp?ucode=${user.ucode}"><img src="img/read.png" alt="查看" title="查看"/></a>
                            </c:if>
                            <c:if test="${user_edit}">
                                <a href="userUpdate.jsp?ucode=${user.ucode}"><img src="img/xiugai.png" alt="修改" title="修改"/></a>
                            </c:if>
                            <c:if test="${user_delete}">
                                <a href="delete?ucode=${user.ucode}" class="removeUser"><img src="img/schu.png" alt="删除" title="删除"/></a>
                            </c:if>
                        </td>
                    </tr>
                </c:forEach>
